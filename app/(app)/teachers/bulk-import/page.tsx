...
export default function TeacherBulkImportPage() {
  ...
  const handleUpload = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await authenticatedFetch("/api/teachers/bulk-import", {
        method: "POST",
      ...
      toast.success(
        `${data.data?.successful || data.successful || 0} teachers imported successfully`,
        { duration: 5000 }
      );
      setFile(null);
    } catch (err: unknown) {
    ...
    <div>
      ...
      <div className="form-card">
        <div style={{ marginBottom: "2rem", padding: "1.5rem", background: "#f0fdf4", border: "1px solid #bbf7d0", borderRadius: 8 }}>
          ...
          <a
            href="/api/teachers/bulk-import/template"
...
Abiola Oluwaseun,abiola@school.com,09087654321,class_teacher,B.A Education,General Studies`}
          ...
          <div style={{ marginBottom: "1.5rem", padding: "1rem", background: "#fef3c7", border: "1px solid #fcd34d", borderRadius: 8 }}>
            <p style={{ margin: 0, fontSize: "1.2rem", color: "#92400e" }}>
              <strong>⚠️ Valid Roles:</strong> subject_teacher, class_teacher, vp_academics, vp_admin, principal, bursar, admin_staff
            </p>
          </div>
          ...
          >
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "1.5rem", marginBottom: "1.5rem" }}>
              <div style={{ padding: "1rem", background: "#fff", borderRadius: 6, border: "1px solid #e2e8f0" }}>
                <div style={{ fontSize: "1.2rem", color: "#64748b", marginBottom: "0.5rem" }}>Successful</div>
            ...
            {result.defaultPassword && (
              <div style={{ padding: "1rem", background: "#fff", borderRadius: 6, marginBottom: "1.5rem", border: "1px solid #e2e8f0" }}>
                <p style={{ margin: "0 0 0.5rem 0", fontWeight: 600 }}>Default Password for New Teachers:</p>
