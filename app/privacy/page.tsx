      ...
      <nav className={`web-navbar ${isScrolled ? "scrolled" : ""}`}>
        <div className="web-container web-navbar__inner">
          ...
          <div className={`nav-links ${menuOpen ? "nav-links--open" : ""}`}>
            ...
            <Link href="/privacy" className="active" onClick={() => setMenuOpen(false)}>
              Privacy
            </Link>
        ...
        <main className="legal-content">
          ...
          <div className="legal-footer-actions">
            ...
            <div className="legal-btns">
              <button className="btn-download" onClick={() => toast.success("PDF download started!")}>Download PDF</button>
